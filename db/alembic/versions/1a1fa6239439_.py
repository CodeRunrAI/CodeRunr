...
def upgrade() -> None:
    ...
    sa.Column('enable_per_process_and_thread_time_limit', sa.Boolean(), nullable=False),
    sa.Column('enable_per_process_and_thread_memory_limit', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
