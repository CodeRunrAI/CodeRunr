...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_submission_batches_token"),
        "submission_batches",
        ["token"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column(
            "limit_per_process_and_thread_cpu_time_usages", sa.Boolean(), nullable=False
        ),
        sa.Column(
            "limit_per_process_and_thread_memory_usages", sa.Boolean(), nullable=False
        ),
